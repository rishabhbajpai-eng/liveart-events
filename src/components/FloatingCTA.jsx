    ...
    >
      ...
      <MagneticButton>
        <a 
          ...
          className="group relative flex items-center justify-center w-20 h-20 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-500 hover:shadow-[#25D366]/40"
        >
