      ...
      <section id="partner" className="py-20 lg:py-32 bg-snow relative overflow-hidden min-h-screen flex items-center">
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-4xl sm:text-6xl lg:text-7xl font-display text-ink mb-6 lg:mb-8 leading-tight">
            ...
            <span className="text-ocean italic">{t('Event Planner?', 'इवेंट प्लानर हैं?')}</span>
          </h2>
          <p className="text-ink/60 mb-10 lg:mb-12 text-lg lg:text-xl leading-relaxed">
            Partner with us and bring India&apos;s most unique DIY experiences to your clients. 
            Enjoy a <span className="text-ocean font-black">12% referral commission</span> on every successful booking.
          </p>
          <motion.a 
            ...
            className="inline-block bg-ink text-snow px-10 lg:px-16 py-4 lg:py-6 rounded-full font-black text-lg lg:text-xl transition-all"
          >
