        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-12 lg:mb-20">
            <motion.span 
              ...
              className="text-firozi font-black tracking-[0.3em] lg:tracking-[0.4em] text-[10px] lg:text-xs uppercase mb-4 block"
            >
              {t('Join the Celebration', 'उत्सव में शामिल हों')}
            </motion.span>
            <h2 className="text-4xl sm:text-6xl lg:text-8xl font-display text-snow mb-6">#LiveArtMoments</h2>
            <p className="text-snow/40 text-base lg:text-lg">Real smiles, real crafts, real party vibes.</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {[
              ...
              <motion.div 
                ...
                className="aspect-square bg-snow/5 rounded-[24px] lg:rounded-[32px] overflow-hidden group border-2 border-white/5"
              >
                <img 
          ...
          <div className="mt-12 lg:mt-20 text-center">
            <motion.a 
              ...
              href="#" 
              className="inline-flex items-center gap-3 lg:gap-4 text-firozi font-black text-lg lg:text-xl uppercase tracking-widest"
            >
              <Instagram size={24} />
              @liveartevents.in
            </motion.a>
